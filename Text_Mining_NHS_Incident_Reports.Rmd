...
- Word-based models are easy to implement, but require practise
 - `tidytext` is a great way to access it if you know `tidyverse`
...
I hope this encouraged you to try an apply these methods yourself
