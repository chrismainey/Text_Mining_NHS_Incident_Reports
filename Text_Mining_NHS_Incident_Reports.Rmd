...
- Tokenise (split into words _(below)_, n-grams, or "skip-grams")
- Remove stop words
...
- Various approaches, but a common option: Latent Dirichlet Allocation (LDA) _(Blei, 2003)_ 
...
- How many topics?
 ...
 - EM or MCMC approaches differ slightly
